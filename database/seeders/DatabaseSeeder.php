...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::create(['name' => 'Gomaa', 'email' => 'gomaa@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('123123123'), 'remember_token' => Str::random(10),]);

        User::create(['name' => 'Amr', 'email' => 'amr@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('123123123'), 'remember_token' => Str::random(10),]);
